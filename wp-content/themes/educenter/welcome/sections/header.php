<div class="welcome-header clearfix">
    <div class="welcome-intro">
        ...
        <div class="free-pro-demos">
            <a class="button button-primary" href="https://demo.sparklewpthemes.com/educenterpro/demos/" target="_blank"><span class="dashicons dashicons-visibility"></span><?php esc_html_e('Free Demos', 'educenter'); ?></a>
    ...
    <div class="welcome-promo-banner">
        <a class="welcome-promo-offer" href="<?php echo esc_url('https://sparklewpthemes.com/wordpress-themes/educenterpro/'); ?>" target="_blank"><?php echo esc_html__('Unlock all the possibilities with Educenter Pro', 'educenter'); ?></a>
        <a href="<?php echo esc_url('https://sparklewpthemes.com/wordpress-themes/educenterpro'); ?>" target="_blank" class="button button-primary upgrade-btn"><?php echo esc_html__('Upgrade for $59', 'educenter'); ?></a>
    </div>
</div>
